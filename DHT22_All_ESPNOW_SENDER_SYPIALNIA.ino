...
DHT dht1(DHTPIN1, DHTTYPE); //prysznic

// current temperature & humidity, updated in loop()
float t = 0.0;
float h = 0.0;
float t1 = 0.0; //prysznic
float h1 = 0.0; //prysznic
...
void handleTemperature1() { 
    ...
    server.send(200, "text/JSON", String("{\"sypialnia\":" + String(t)+",\"prysznic\":"+ String(t1)+"}").c_str());
...
void handlehumidity1() { 
  
     server.send(200, "text/JSON", String("{\"sypialnia\":" + String(h)+",\"prysznic\":"+ String(h1)+"}").c_str());
...
//  server.begin();
    ...
    server.on("/temperatureprysznic", handleTemperature1);
    server.on("/humidityprysznic", handlehumidity1); 
